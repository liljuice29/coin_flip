...
static constexpr auto qt_meta_stringdata_CLASSchoosesceneENDCLASS = QtMocHelpers::stringData(
    "choosescene",
    "choosesceneback",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSchoosesceneENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSchoosesceneENDCLASS_t qt_meta_stringdata_CLASSchoosesceneENDCLASS = {
    {
        QT_MOC_LITERAL(0, 11),  // "choosescene"
        QT_MOC_LITERAL(12, 15),  // "choosesceneback"
        QT_MOC_LITERAL(28, 0)   // ""
    },
    "choosescene",
    "choosesceneback",
...
void choosescene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &choosescene::choosesceneback; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void choosescene::choosesceneback()
{
